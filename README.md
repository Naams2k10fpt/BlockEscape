...
- Player gravity được quản lý trong `PlayerConfig` và đang đặt `gravityScale = 4` để giảm cảm giác rơi lơ lửng.
...
- Khi bị block đè mà còn tim, player mất 1 tim rồi respawn ở điểm trống gần giữa arena, cao hơn block đã khóa cao nhất 5 đơn vị Y; player nhấp nháy bất tử 3 giây, chỉ hết tim mới Game Over.
